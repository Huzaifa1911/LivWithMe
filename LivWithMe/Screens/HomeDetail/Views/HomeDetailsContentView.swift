...
protocol HomeDetailsContentViewDelegate: AnyObject {
    func didTapHomeContentViewBackButton()
}

class HomeDetailsContentView: VerticalScrollableView {
    private var home: Home
    
    weak var homeDetailDelegate: HomeDetailsContentViewDelegate? = nil
...
extension HomeDetailsContentView: HomeInfoViewDelegate {
